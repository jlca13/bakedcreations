    ...
    <div class="order-form">
      <div class="product-preview">
        <div class="left-column">
          <h1 class="cake-name">UBE PEANUT CAKE</h1>
          <hr>
        ...
        <div class="right-column">
          <img src="../images/cake1.png" class="product-img">
            ...
            <ul class="product-description">
              <li>
                ...
                <div class="description-dropdown">
                  <p>
                    Dive into a fusion of Filipino flavors with our Ube Peanut Cake! This vibrant, purple delight combines the earthy sweetness of ube with nuts as topper. Each bite is a journey to flavor paradise, with moist layers that melt in your mouth.<br><br>
                    Ingredients:<br>
                    Ube, peanut butter, flour, sugar, eggs, baking powder.<br><br>
                    Allergens:<br>
                    Peanuts, eggs, wheat<br>
