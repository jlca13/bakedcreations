    ...
    <div class="order-form">
      <div class="product-preview">
        <div class="left-column">
          <h1 class="cake-name">CARAMEL GLAZED CAKE</h1>
          <hr>
        ...
        <div class="right-column">
          <img src="../images/cake3.png" class="product-img">
            ...
            <ul class="product-description">
              <li>
                ...
                <div class="description-dropdown">
                  <p> Experience the bliss of our Caramel Glazed Cake, where rich, moist layers meet a decadent caramel glaze. This cake is a symphony of buttery sweetness that will leave you craving more. Perfect for any occasion that calls for a touch of indulgence.<br><br>
                    Ingredients:<br>
                    Flour, sugar, butter, eggs, caramel sauce.<br><br>
